...
- Customize the widget's API URL and channel name from the WordPress admin panel.
...
You can customize the widget using the plugin settings in the WordPress admin area to define the API URL and channel name.
...
3. Go to **Settings > Hexabot Chat Widget** to configure the API URL and channel name.

== Frequently Asked Questions ==

= How do I configure the chat widget settings? =
After activating the plugin, navigate to **Settings > Hexabot Chat Widget** in your WordPress dashboard. Here, you can configure the widget's API URL and channel.
